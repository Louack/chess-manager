    ...
    const body = 
        <div className='modal-description'>
            ...
            <ul>
                ...
                <li>Compléter les matchs des rondes suivantes, jusqu'à complétion du tournoi.</li>
                <li>Le classement des joueurs est disponible à tout moment sur la page du tournoi.</li>
            </ul>
            <h4>Système de jeu</h4>
            <p>Les joueurs sont appariés selon deux algorithmes, inspirés du système de jeu suisse :</p>
            <ul>
